...
public class CSS {
	...
	public static const topBarColor:int =  0x202020;  /*0x202020*/ //0x00A8FF;
	public static const tabColor:int = 0x353535;/*0x999999;*/
	public static const panelColor:int = 0x202020;
	public static const itemSelectedColor:int = 0x003355;
	public static const borderColor:int = textColor;//0x77FFBB;
	public static const textColor:int = 0x33DEFF; // 0x6C6D6F
	...
	public static const overColor:int = 0x00A8FF;
	...
	*/
	...
	// Fonts
	public static const font:String = Resources.chooseFont(['Champagne & Limousines Regular']);
	...
	// Section title bars
	public static const titleBarColors:Array = [/*white*/0x555555, tabColor];
